...
?>
  ...
  <head>
    ...
    <title>Constancia de pase para Estatuto</title>
    <style>
      body {
...
<!--      <iframe id="ifmcontentstoprint" style="height: 500px; width: 100%;"></iframe>-->
    ...
    <form class="form-horizontal" method="POST"  enctype="multipart/form-data" autocomplete="off" id="form_const_estatuto">
      <form>
        ...
        <!--------------DOCE----------------->
        <label for="jefe_inmediato">Jefe del Servicio:</label>
    ...
    <script>
        window.onload = function() {
            const form = document.getElementById('form_const_estatuto')
            form.addEventListener('submit', function(e) {
                e.preventDefault()
                const formData = new FormData(form)
                axios.post('guardar_Const_Pase_Estatuto.php', formData)
                    .then(response => {
            ...
            //     tipo_documento:"CONSTANCIA DE PASE",
            //     turno:"MATUTINO",
            // }
            ...
            function imprimirArchivo(data){
                ...
                title('CONSTANCIA DE PASE PARA ESTATUTO DE TRABAJADORES DE CONFIANZA “A”', 160, 18)
                ...
                text('Clave: 1A74-009-083', 170, 133)
                //descargar
                doc.save('constancia_pase_estatuto.pdf')
