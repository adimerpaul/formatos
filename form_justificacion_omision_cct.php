...
<head>
  ...
  <title>Justificacion Omision CCT</title>
    ...
    <div id="contenedorFormato_1" class="container">
      <div class="row border_1">
        ...
        <div class="col-md-3 col-xs-3 text-center m-3">
          <p>
          <h6 style="text-align: center;">JUSTIFICACIÓN POR <br> OMISIÓN DE REGISTRO</h6>
          </p>
          <div class="text-center">
            <label for="folio">Folio</label>
            <div style="display: inline-block;" class="subrayado">JC_<?= isset($datos_incidencia['folio']) ? $datos_incidencia['folio'] : ''; ?></div>
          </div>
        </div>
        ...
        <div class="row" style="padding-top: 0px; padding-left: 0px; padding-right: 5px; padding-bottom: 0px;">
          <div class="col-md-12">
            ...
            <div>El trabajador debe registrar asistencia en apego al art. 21 del RIT;
              por excepción y conforme al art. 28 del RIT, se justifica la omisión del registro de:
            ...
            <!-- Este es un renglon donde las columnas deben sumar 12-->
            <div class="col-md-3"> Motivo de la omisión:</div>
            <div class="col-md-5 subrayado"><?= $datos_incidencia['motivo'] ?></div>
            <!-- termina renglon donde las columnas deben sumar 12-->
          </div>
          <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          <div class="col-md-12 col-xs-3">
            <div class="texto-vertical-2"> Clave: 1A12-0009-041</div>
          </div>
        </div>
      </div>
    </div>
